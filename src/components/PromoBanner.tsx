...
const PromoBanner: React.FC<PromoBannerProps> = ({ onClose }) => {
  ...
  const targetDate = new Date("2026-07-04T23:59:00Z");
      ...
      <div className="container mx-auto flex items-center justify-center gap-4 md:gap-8 pr-8">
        ...
        <div className="flex md:hidden items-center justify-between w-full">
          <div className="flex flex-col items-start">
            ...
            <p className="text-[11px] text-white/80">Prices increase after July 4th</p>
        ...
        <div className="hidden md:flex items-center gap-8">
          <div className="text-center">
            ...
            <p className="text-sm text-white/80">Prices increase after July 4th</p>
          </div>
