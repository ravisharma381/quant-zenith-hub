  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Practice quant interview questions frequently asked at Jane Street, Citadel, DRW, and top trading firms. Includes derivatives, probability, risk management, statistics, and finance problems."
        />
        <meta name="robots" content="index, follow" />

        {/* OpenGraph */}
        <meta property="og:title" content="Quant Interview Questions & Problems" />
        <meta property="og:description" content="Practice quant problems asked at top trading firms like Jane Street, Citadel, DRW, and more." />
        <meta property="og:image" content="/og/quant-problems.png" />
        <meta property="og:type" content="website" />

        {/* ItemList Schema (SEO BOOSTER) */}
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "ItemList",
            itemListElement: filteredProblems.map((p, index) => ({
              "@type": "ListItem",
              position: index + 1,
              name: p.title,
