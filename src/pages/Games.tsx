    ...
    switch (gameId) {
      case 1: // Arithmetic Pro - Green (default)
        return {
          ...
          buttonStyles: "!bg-[hsl(122,97%,50%)] !text-[hsl(220,13%,8%)] hover:!bg-[hsl(122,97%,50%)]/90 hover:!shadow-[0_0_20px_hsl(122,97%,50%,0.3)] !border-[hsl(122,97%,50%)] focus-visible:!ring-[hsl(122,97%,50%)]"
        };
      case 2: // Sequences Pro - Purple
        return {
          ...
          buttonStyles: "!bg-[hsl(270,95%,60%)] !text-[hsl(220,13%,8%)] hover:!bg-[hsl(270,95%,60%)]/90 hover:!shadow-[0_0_20px_hsl(270,95%,60%,0.3)] !border-[hsl(270,95%,60%)] focus-visible:!ring-[hsl(270,95%,60%)]"
        };
      case 3: // Optiver 80 - Red
        return {
          ...
          buttonStyles: "!bg-[hsl(0,84%,60%)] !text-[hsl(220,13%,8%)] hover:!bg-[hsl(0,84%,60%)]/90 hover:!shadow-[0_0_20px_hsl(0,84%,60%,0.3)] !border-[hsl(0,84%,60%)] focus-visible:!ring-[hsl(0,84%,60%)]"
        };
      default:
        return {
          primary: "hsl(122, 97%, 50%)",
